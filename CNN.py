...
model1.add(Conv2D(filters=32, kernel_size=(3, 3), input_shape=(21, 45, 1), activation='relu', padding='same',
                 name='block_1_conv'))  # 接收圖片為21*45且為灰階(1)
...
# 訓練階段
# 訓練資料/訓練標籤/疊代30次/每次訓練抓130個樣本/訓練提早結束/
model_history = model1.fit(train_images, train_labels, epochs=30, batch_size=130, callbacks=callback1, validation_data=(test_images, test_labels))
